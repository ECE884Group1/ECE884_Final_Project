...
- If you don't have TensorFlow installed already, install your favourite flavor of TensorFlow. In most cases, you may use
    ...
    In the codes for the baseline methods for both the Cartpole and the Mountain car environments, Keras has been used to implement Tensorflow. Keras is an open-source software library that provides a Python interface for the TensorFlow library. To install Keras, the following can be used:
    ```bash 
   pip install keras
    ```
