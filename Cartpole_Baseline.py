...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  9 01:37:48 2021
...
####
    ...
    plt.show()
    action_model.save('cartpole_model3.h5')  ## Save the Trained Model
    del action_model
    action_model = load_model('cartpole_model3.h5')  ## Load the Trained Model
